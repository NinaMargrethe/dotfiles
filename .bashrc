...
# MAcOS
# To make this work, do $ curl -o ~/.git-prompt.sh https://raw.githubusercontent.com/git/git/master/contrib/completion/git-pmpt.sh
...
# [hh:mm] host:usericon. Red # if root, else green $. Yellow git branch.
